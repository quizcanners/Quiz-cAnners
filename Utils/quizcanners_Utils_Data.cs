...
namespace QuizCanners.Utils
{
    ...
    public static class QcFile
    {
        ...
        public static class Explorer
        {
            ...
            {
#if UNITY_EDITOR
                var dest = QcUnity.RemoveAssetsFromPath(AssetDatabase.GetAssetPath(o));
        ...
        public static class Delete
        {
            public class InPersistentFolder 
            {
                ...
                public static void DeleteDirectory(RelativeLocation location, bool deleteSubdirectories = true, bool showNotificationInGameView = true) =>
                    DeleteDirectory(location.FolderName, deleteSubdirectories: deleteSubdirectories, showNotificationInGameView: showNotificationInGameView);
